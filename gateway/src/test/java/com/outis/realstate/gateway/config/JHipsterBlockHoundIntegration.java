...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.outis.realstate.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.outis.realstate.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
