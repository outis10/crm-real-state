...
export const Notification = () => {
  ...
  const totalItems = useAppSelector(state => state.notification.notification.totalItems);
            ...
            <tbody>
              {notificationList.map((notification, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/notification/notification/${notification.id}`} color="link" size="sm">
                      {notification.id}
                    </Button>
                  </td>
                  <td>{notification.entityId}</td>
                  <td>
                    <Translate contentKey={`notificationApp.EntityNameEnum.${notification.entityName}`} />
                  </td>
                  <td>
                    <Translate contentKey={`notificationApp.NotificationTargetEnum.${notification.target}`} />
                  </td>
                  <td>{notification.content}</td>
                  <td>
                    <Translate contentKey={`notificationApp.NotificationStatusEnum.${notification.status}`} />
                  </td>
                  <td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/notification/notification/${notification.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/notification/notification/${notification.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
