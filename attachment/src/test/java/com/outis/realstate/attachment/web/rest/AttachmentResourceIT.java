package com.outis.realstate.attachment.web.rest;
...
import com.outis.realstate.attachment.IntegrationTest;
import com.outis.realstate.attachment.domain.Attachment;
import com.outis.realstate.attachment.domain.enumeration.EntityNameEnum;
import com.outis.realstate.attachment.repository.AttachmentRepository;
import com.outis.realstate.attachment.service.dto.AttachmentDTO;
import com.outis.realstate.attachment.service.mapper.AttachmentMapper;
...
class AttachmentResourceIT {
    ...
    void partialUpdateAttachmentWithPatch() throws Exception {
        ...
        partialUpdatedAttachment.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).entityName(UPDATED_ENTITY_NAME);
