...
export const AttachmentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/attachment/attachment${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="attachmentApp.attachmentAttachment.delete.question">
        <Translate contentKey="attachmentApp.attachmentAttachment.delete.question" interpolate={{ id: attachmentEntity.id }}>
