    ...
    <Row>
      <Col md="8">
        <h2 data-cy="attachmentDetailsHeading">
          <Translate contentKey="attachmentApp.attachmentAttachment.detail.title">Attachment</Translate>
        </h2>
        ...
        &nbsp;
        <Button tag={Link} to={`/attachment/attachment/${attachmentEntity.id}/edit`} replace color="primary">
