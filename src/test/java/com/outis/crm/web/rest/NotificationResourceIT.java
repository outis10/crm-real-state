...
class NotificationResourceIT {
    ...
    public static Notification createEntity() {
        return new Notification().target(DEFAULT_TARGET).content(DEFAULT_CONTENT).status(DEFAULT_STATUS).timestamp(DEFAULT_TIMESTAMP);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().target(UPDATED_TARGET).content(UPDATED_CONTENT).status(UPDATED_STATUS).timestamp(UPDATED_TIMESTAMP);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.target(UPDATED_TARGET).content(UPDATED_CONTENT).status(UPDATED_STATUS).timestamp(UPDATED_TIMESTAMP);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.target(UPDATED_TARGET).content(UPDATED_CONTENT).timestamp(UPDATED_TIMESTAMP);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.target(UPDATED_TARGET).content(UPDATED_CONTENT).status(UPDATED_STATUS).timestamp(UPDATED_TIMESTAMP);
