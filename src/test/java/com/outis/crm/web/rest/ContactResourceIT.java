...
class ContactResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "7|\\xG2@BKsbR\\.\"uFkl-";
    private static final String UPDATED_EMAIL = "}vj)3@9Wb;?.X7>'";

    private static final String DEFAULT_PHONE = "4731743484756";
    private static final String UPDATED_PHONE = "+71444619197";
    ...
    private static final String DEFAULT_POSTAL_CODE = "08746-2531";
    private static final String UPDATED_POSTAL_CODE = "14992";
