...
describe('Attachment e2e test', () => {
  ...
  const attachmentSample = { file: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=', fileContentType: 'unknown', entityId: 4250 };
  ...
  describe('new Attachment page', () => {
    ...
    it('should create an instance of Attachment', () => {
      ...
      cy.get(`[data-cy="entityId"]`).type('13342');
      cy.get(`[data-cy="entityId"]`).should('have.value', '13342');
