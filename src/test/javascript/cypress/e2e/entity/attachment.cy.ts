...
describe('Attachment e2e test', () => {
  ...
  const attachmentSample = { file: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=', fileContentType: 'unknown', entityId: 23177 };
  ...
  describe('Attachment page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of Attachment', () => {
        cy.intercept('GET', '/api/attachments/*').as('dialogDeleteRequest');
  ...
  describe('new Attachment page', () => {
    ...
    it('should create an instance of Attachment', () => {
      ...
      cy.get(`[data-cy="entityId"]`).type('12756');
      cy.get(`[data-cy="entityId"]`).should('have.value', '12756');
