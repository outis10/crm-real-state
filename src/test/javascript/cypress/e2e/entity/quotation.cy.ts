...
describe('Quotation e2e test', () => {
  ...
  const quotationSample = { finalPrice: 12060.47, validityDate: '2025-02-12T03:15:02.176Z' };
  ...
  describe('new Quotation page', () => {
    ...
    it('should create an instance of Quotation', () => {
      cy.get(`[data-cy="finalPrice"]`).type('12677.11');
      cy.get(`[data-cy="finalPrice"]`).should('have.value', '12677.11');

      cy.get(`[data-cy="validityDate"]`).type('2025-02-12T09:41');
      cy.get(`[data-cy="validityDate"]`).blur();
      cy.get(`[data-cy="validityDate"]`).should('have.value', '2025-02-12T09:41');

      cy.get(`[data-cy="comments"]`).type('yowza');
      cy.get(`[data-cy="comments"]`).should('have.value', 'yowza');
