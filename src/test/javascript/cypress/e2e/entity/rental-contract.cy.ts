...
describe('RentalContract e2e test', () => {
  ...
  const rentalContractSample = {
    startDate: '2025-02-12T23:26:50.200Z',
    endDate: '2025-02-12T09:35:14.255Z',
    monthlyRent: 7845.98,
    status: 'FINISHED',
  };
  ...
  describe('new RentalContract page', () => {
    ...
    it('should create an instance of RentalContract', () => {
      cy.get(`[data-cy="startDate"]`).type('2025-02-12T16:14');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2025-02-12T16:14');

      cy.get(`[data-cy="endDate"]`).type('2025-02-12T10:05');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2025-02-12T10:05');

      cy.get(`[data-cy="monthlyRent"]`).type('31216.66');
      cy.get(`[data-cy="monthlyRent"]`).should('have.value', '31216.66');

      cy.get(`[data-cy="securityDeposit"]`).type('11696.77');
      cy.get(`[data-cy="securityDeposit"]`).should('have.value', '11696.77');
