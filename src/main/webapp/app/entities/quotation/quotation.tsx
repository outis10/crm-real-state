  ...
  return (
    <div>
      <h2 id="quotation-heading" data-cy="QuotationHeading">
        <Translate contentKey="crmRealStateApp.quotation.home.title">Quotations</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="crmRealStateApp.quotation.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/quotation/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="crmRealStateApp.quotation.home.createLabel">Create new Quotation</Translate>
          </Link>
        </div>
      </h2>
        ...
        {quotationList && quotationList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="crmRealStateApp.quotation.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="crmRealStateApp.quotation.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="crmRealStateApp.quotation.property">Property</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {quotationList.map((quotation, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{quotation.property ? <Link to={`/property/${quotation.property.id}`}>{quotation.property.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="crmRealStateApp.quotation.home.notFound">No Quotations found</Translate>
            </div>
          )
        )}
      </div>
