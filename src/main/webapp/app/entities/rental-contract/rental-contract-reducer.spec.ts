...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RENTALCONTRACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RENTALCONTRACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RENTALCONTRACT actions', async () => {
      const arg = { id: 31745 };
    ...
    it('dispatches UPDATE_RENTALCONTRACT actions', async () => {
      const arg = { id: 31745 };
    ...
    it('dispatches PARTIAL_UPDATE_RENTALCONTRACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RENTALCONTRACT actions', async () => {
      const arg = 42666;
