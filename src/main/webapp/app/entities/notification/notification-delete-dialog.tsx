...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmRealStateApp.notification.delete.question">
        <Translate contentKey="crmRealStateApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
