...
export const OpportunityDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmRealStateApp.opportunity.delete.question">
        <Translate contentKey="crmRealStateApp.opportunity.delete.question" interpolate={{ id: opportunityEntity.id }}>
