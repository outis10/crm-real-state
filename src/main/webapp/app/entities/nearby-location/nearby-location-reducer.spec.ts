...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NEARBYLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NEARBYLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NEARBYLOCATION actions', async () => {
      const arg = { id: 5015 };
    ...
    it('dispatches UPDATE_NEARBYLOCATION actions', async () => {
      const arg = { id: 5015 };
    ...
    it('dispatches PARTIAL_UPDATE_NEARBYLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NEARBYLOCATION actions', async () => {
      const arg = 42666;
