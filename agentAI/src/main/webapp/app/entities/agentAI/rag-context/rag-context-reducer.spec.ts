...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAGCONTEXT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAGCONTEXT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAGCONTEXT actions', async () => {
      const arg = { id: '9fe71409-9359-428b-9742-c53f85da92a8' };
    ...
    it('dispatches UPDATE_RAGCONTEXT actions', async () => {
      const arg = { id: '9fe71409-9359-428b-9742-c53f85da92a8' };
    ...
    it('dispatches PARTIAL_UPDATE_RAGCONTEXT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_RAGCONTEXT actions', async () => {
      const arg = 42666;
