...
export const ChatInteractionDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/agentai/chat-interaction${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="agentAiApp.agentAiChatInteraction.delete.question">
        <Translate contentKey="agentAiApp.agentAiChatInteraction.delete.question" interpolate={{ id: chatInteractionEntity.id }}>
