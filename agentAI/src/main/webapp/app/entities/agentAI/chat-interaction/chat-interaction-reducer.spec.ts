...
import { IChatInteraction, defaultValue } from 'app/shared/model/agentAI/chat-interaction.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATINTERACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHATINTERACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHATINTERACTION actions', async () => {
      const arg = { id: 'c38af368-2e2d-405b-b3d1-722487357b10' };
    ...
    it('dispatches UPDATE_CHATINTERACTION actions', async () => {
      const arg = { id: 'c38af368-2e2d-405b-b3d1-722487357b10' };
    ...
    it('dispatches PARTIAL_UPDATE_CHATINTERACTION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CHATINTERACTION actions', async () => {
      const arg = 42666;
