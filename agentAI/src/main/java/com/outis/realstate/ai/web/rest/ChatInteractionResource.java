...
/**
 * REST controller for managing {@link com.outis.realstate.ai.domain.ChatInteraction}.
 */
@RestController
...
public class ChatInteractionResource {
    ...
    private static final String ENTITY_NAME = "agentAiChatInteraction";
    ...
    public ResponseEntity<ChatInteractionDTO> createChatInteraction(@Valid @RequestBody ChatInteractionDTO chatInteractionDTO)
        ...
        return ResponseEntity.created(new URI("/api/chat-interactions/" + chatInteractionDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, chatInteractionDTO.getId()))
    ...
    public ResponseEntity<ChatInteractionDTO> updateChatInteraction(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, chatInteractionDTO.getId()))
            .body(chatInteractionDTO);
    }
    ...
    public ResponseEntity<ChatInteractionDTO> partialUpdateChatInteraction(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, chatInteractionDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ChatInteractionDTO> getChatInteraction(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteChatInteraction(@PathVariable("id") String id) {
