...
import com.outis.realstate.properties.repository.QuotationRepository;
import com.outis.realstate.properties.service.dto.QuotationDTO;
import com.outis.realstate.properties.service.mapper.QuotationMapper;
...
class QuotationResourceIT {
    ...
    void partialUpdateQuotationWithPatch() throws Exception {
        ...
        partialUpdatedQuotation.finalPrice(UPDATED_FINAL_PRICE).comments(UPDATED_COMMENTS);
