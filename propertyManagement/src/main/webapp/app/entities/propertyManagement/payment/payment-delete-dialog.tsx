...
export const PaymentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/propertymanagement/payment${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="propertyManagementApp.propertyManagementPayment.delete.question">
        <Translate contentKey="propertyManagementApp.propertyManagementPayment.delete.question" interpolate={{ id: paymentEntity.id }}>
