...
import { ISale, defaultValue } from 'app/shared/model/propertyManagement/sale.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sale.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SALE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SALE actions', async () => {
      const arg = { id: 10270 };
    ...
    it('dispatches UPDATE_SALE actions', async () => {
      const arg = { id: 10270 };
    ...
    it('dispatches PARTIAL_UPDATE_SALE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SALE actions', async () => {
      const arg = 42666;
