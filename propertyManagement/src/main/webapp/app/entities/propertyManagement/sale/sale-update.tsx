...
export const SaleUpdate = () => {
  ...
  const updating = useAppSelector(state => state.propertymanagement.sale.updating);
  ...
  const handleClose = () => {
    navigate(`/propertymanagement/sale${location.search}`);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="propertyManagementApp.propertyManagementSale.home.createOrEditLabel" data-cy="SaleCreateUpdateHeading">
            <Translate contentKey="propertyManagementApp.propertyManagementSale.home.createOrEditLabel">Create or edit a Sale</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('propertyManagementApp.propertyManagementSale.propertyId')}
                id="sale-propertyId"
                name="propertyId"
                data-cy="propertyId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('propertyManagementApp.propertyManagementSale.customerId')}
                id="sale-customerId"
                name="customerId"
                data-cy="customerId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('propertyManagementApp.propertyManagementSale.oportunityId')}
              ...
              />
              <ValidatedField
                label={translate('propertyManagementApp.propertyManagementSale.saleDate')}
                id="sale-saleDate"
                name="saleDate"
                data-cy="saleDate"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('propertyManagementApp.propertyManagementSale.totalAmount')}
                id="sale-totalAmount"
                name="totalAmount"
                data-cy="totalAmount"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('propertyManagementApp.propertyManagementSale.status')}
                id="sale-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {saleStatusEnumValues.map(saleStatusEnum => (
                  <option value={saleStatusEnum} key={saleStatusEnum}>
                    {translate(`propertyManagementApp.SaleStatusEnum.${saleStatusEnum}`)}
                  </option>
                ))}
              </ValidatedField>
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/propertymanagement/sale" replace color="info">
