...
export const ChargeDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/propertymanagement/charge${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="propertyManagementApp.propertyManagementCharge.delete.question">
        <Translate contentKey="propertyManagementApp.propertyManagementCharge.delete.question" interpolate={{ id: chargeEntity.id }}>
