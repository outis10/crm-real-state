...
import { ICharge, defaultValue } from 'app/shared/model/propertyManagement/charge.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './charge.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHARGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHARGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHARGE actions', async () => {
      const arg = { id: 12981 };
    ...
    it('dispatches UPDATE_CHARGE actions', async () => {
      const arg = { id: 12981 };
    ...
    it('dispatches PARTIAL_UPDATE_CHARGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHARGE actions', async () => {
      const arg = 42666;
