...
import { IQuotation, defaultValue } from 'app/shared/model/propertyManagement/quotation.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './quotation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUOTATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUOTATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUOTATION actions', async () => {
      const arg = { id: 14166 };
    ...
    it('dispatches UPDATE_QUOTATION actions', async () => {
      const arg = { id: 14166 };
    ...
    it('dispatches PARTIAL_UPDATE_QUOTATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUOTATION actions', async () => {
      const arg = 42666;
