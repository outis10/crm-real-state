...
export const QuotationDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/propertymanagement/quotation${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="propertyManagementApp.propertyManagementQuotation.delete.question">
        <Translate contentKey="propertyManagementApp.propertyManagementQuotation.delete.question" interpolate={{ id: quotationEntity.id }}>
