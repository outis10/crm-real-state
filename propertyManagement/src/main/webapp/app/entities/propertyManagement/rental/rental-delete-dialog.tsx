...
import { deleteEntity, getEntity } from './rental.reducer';
...
export const RentalDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/propertymanagement/rental${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="propertyManagementApp.propertyManagementRental.delete.question">
        <Translate contentKey="propertyManagementApp.propertyManagementRental.delete.question" interpolate={{ id: rentalEntity.id }}>
