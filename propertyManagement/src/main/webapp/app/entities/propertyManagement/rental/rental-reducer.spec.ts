...
import { IRental, defaultValue } from 'app/shared/model/propertyManagement/rental.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './rental.reducer';
