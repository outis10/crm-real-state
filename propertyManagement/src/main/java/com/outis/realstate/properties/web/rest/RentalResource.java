...
import com.outis.realstate.properties.repository.RentalRepository;
import com.outis.realstate.properties.service.RentalService;
...
/**
 * REST controller for managing {@link com.outis.realstate.properties.domain.Rental}.
 */
@RestController
...
public class RentalResource {
    ...
    private static final String ENTITY_NAME = "propertyManagementRental";
    ...
    public ResponseEntity<RentalDTO> createRental(@Valid @RequestBody RentalDTO rentalDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/rentals/" + rentalDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, rentalDTO.getId().toString()))
            .body(rentalDTO);
    }
