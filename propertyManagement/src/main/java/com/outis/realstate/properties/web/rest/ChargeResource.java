package com.outis.realstate.properties.web.rest;

import com.outis.realstate.properties.repository.ChargeRepository;
import com.outis.realstate.properties.service.ChargeService;
import com.outis.realstate.properties.service.dto.ChargeDTO;
import com.outis.realstate.properties.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.outis.realstate.properties.domain.Charge}.
 */
@RestController
...
public class ChargeResource {
    ...
    private static final String ENTITY_NAME = "propertyManagementCharge";
    ...
    public ResponseEntity<ChargeDTO> createCharge(@Valid @RequestBody ChargeDTO chargeDTO) throws URISyntaxException {
        ...
        chargeDTO = chargeService.save(chargeDTO);
        return ResponseEntity.created(new URI("/api/charges/" + chargeDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, chargeDTO.getId().toString()))
            .body(chargeDTO);
    }
    ...
    public ResponseEntity<ChargeDTO> updateCharge(
        ...
        chargeDTO = chargeService.update(chargeDTO);
