...
public class Contact implements Serializable {
    ...
    public Customer getAssignedTo() {
        return this.assignedTo;
    }

    public void setAssignedTo(Customer customer) {
        this.assignedTo = customer;
    }

    public Contact assignedTo(Customer customer) {
        this.setAssignedTo(customer);
        return this;
    }
