...
import com.outis.realstate.crm.repository.OpportunityRepository;
import com.outis.realstate.crm.service.OpportunityService;
...
/**
 * REST controller for managing {@link com.outis.realstate.crm.domain.Opportunity}.
 */
@RestController
...
public class OpportunityResource {
    ...
    public ResponseEntity<List<OpportunityDTO>> getAllOpportunities(
        ...
        Page<OpportunityDTO> page;
        if (eagerload) {
            page = opportunityService.findAllWithEagerRelationships(pageable);
        } else {
            page = opportunityService.findAll(pageable);
        }
