...
/**
 * REST controller for managing {@link com.outis.realstate.crm.domain.Rental}.
 */
@RestController
...
public class RentalResource {
    ...
    private static final String ENTITY_NAME = "crmRental";
    ...
    public ResponseEntity<List<RentalDTO>> getAllRentals(
        ...
        Page<RentalDTO> page;
        if (eagerload) {
            page = rentalService.findAllWithEagerRelationships(pageable);
        } else {
            page = rentalService.findAll(pageable);
        }
