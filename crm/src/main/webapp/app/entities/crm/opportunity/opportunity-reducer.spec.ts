...
import { IOpportunity, defaultValue } from 'app/shared/model/crm/opportunity.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPPORTUNITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPPORTUNITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPPORTUNITY actions', async () => {
      const arg = { id: 11348 };
    ...
    it('dispatches UPDATE_OPPORTUNITY actions', async () => {
      const arg = { id: 11348 };
    ...
    it('dispatches PARTIAL_UPDATE_OPPORTUNITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPPORTUNITY actions', async () => {
      const arg = 42666;
