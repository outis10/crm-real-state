...
export const OpportunityDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/crm/opportunity${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.crmOpportunity.delete.question">
        <Translate contentKey="crmApp.crmOpportunity.delete.question" interpolate={{ id: opportunityEntity.id }}>
