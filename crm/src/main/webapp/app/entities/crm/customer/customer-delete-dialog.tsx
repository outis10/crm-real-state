...
export const CustomerDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/crm/customer${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.crmCustomer.delete.question">
        <Translate contentKey="crmApp.crmCustomer.delete.question" interpolate={{ id: customerEntity.id }}>
