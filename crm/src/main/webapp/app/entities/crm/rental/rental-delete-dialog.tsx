...
export const RentalDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/crm/rental${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.crmRental.delete.question">
        <Translate contentKey="crmApp.crmRental.delete.question" interpolate={{ id: rentalEntity.id }}>
