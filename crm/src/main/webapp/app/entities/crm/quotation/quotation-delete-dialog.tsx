...
export const QuotationDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/crm/quotation${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.crmQuotation.delete.question">
        <Translate contentKey="crmApp.crmQuotation.delete.question" interpolate={{ id: quotationEntity.id }}>
