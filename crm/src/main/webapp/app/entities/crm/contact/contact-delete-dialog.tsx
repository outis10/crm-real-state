...
export const ContactDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/crm/contact${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.crmContact.delete.question">
        <Translate contentKey="crmApp.crmContact.delete.question" interpolate={{ id: contactEntity.id }}>
