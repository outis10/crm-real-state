...
export const PaymentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/crm/payment${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.crmPayment.delete.question">
        <Translate contentKey="crmApp.crmPayment.delete.question" interpolate={{ id: paymentEntity.id }}>
