...
export const ChargeDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/crm/charge${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmApp.crmCharge.delete.question">
        <Translate contentKey="crmApp.crmCharge.delete.question" interpolate={{ id: chargeEntity.id }}>
