...
import static com.outis.realstate.crm.domain.CustomerAsserts.*;
...
import com.outis.realstate.crm.repository.CustomerRepository;
import com.outis.realstate.crm.service.dto.CustomerDTO;
import com.outis.realstate.crm.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "ec@<kZ.%QpT";
    private static final String UPDATED_EMAIL = "Qr7QOW@f!t.73%)";

    private static final String DEFAULT_PHONE = "+186007320671304";
    private static final String UPDATED_PHONE = "116126310950756";
    ...
    private static final String DEFAULT_POSTAL_CODE = "71111-8009";
    private static final String UPDATED_POSTAL_CODE = "42053-4650";
    ...
    private static final BigDecimal DEFAULT_RENTAL_BUDGET = new BigDecimal(1);
    private static final BigDecimal UPDATED_RENTAL_BUDGET = new BigDecimal(2);

    private static final String DEFAULT_INTERACTION_HISTORY = "AAAAAAAAAA";
    private static final String UPDATED_INTERACTION_HISTORY = "BBBBBBBBBB";
    ...
    public static Customer createEntity() {
        return new Customer()
            ...
            .rentalBudget(DEFAULT_RENTAL_BUDGET)
            .interactionHistory(DEFAULT_INTERACTION_HISTORY)
    ...
    public static Customer createUpdatedEntity() {
        return new Customer()
            ...
            .rentalBudget(UPDATED_RENTAL_BUDGET)
            .interactionHistory(UPDATED_INTERACTION_HISTORY)
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].rentalBudget").value(hasItem(sameNumber(DEFAULT_RENTAL_BUDGET))))
            .andExpect(jsonPath("$.[*].interactionHistory").value(hasItem(DEFAULT_INTERACTION_HISTORY)))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.rentalBudget").value(sameNumber(DEFAULT_RENTAL_BUDGET)))
            .andExpect(jsonPath("$.interactionHistory").value(DEFAULT_INTERACTION_HISTORY))
