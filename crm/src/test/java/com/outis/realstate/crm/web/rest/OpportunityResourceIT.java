...
import static com.outis.realstate.crm.domain.OpportunityAsserts.*;
...
import com.outis.realstate.crm.service.mapper.OpportunityMapper;
...
class OpportunityResourceIT {
    ...
    void partialUpdateOpportunityWithPatch() throws Exception {
        ...
        partialUpdatedOpportunity.amount(UPDATED_AMOUNT).stage(UPDATED_STAGE).createdAt(UPDATED_CREATED_AT).modifiedAt(UPDATED_MODIFIED_AT);
